        ...
        <div class="container-xxl flex-grow-1 container-p-y">
          ...
          <div class="d-flex justify-content-between">
            ...
            <h4 class="fw-bold py-1 mb-3">
              ...
              @else
              <button type="button" class="btn btn-primary btn-md waves-effect" id="updateIklan">Update</button>
              <a href="{{ route('konten.iklan') }}" type="button" class="btn btn-secondary btn-sm waves-effect" id="backSorot"><span class="mdi mdi-close-thick"></span></a>
              @endif   
            </h4>
          </div>
                 ...
                 value="@if($status_form === "edit_form"){{$item->id_iklan}}@else{{''}}@endif">
                    ...
                    <div class="form-floating form-floating-outline mb-3 mt-3">
                        <select id="kategori" class="select2 form-select" name="kategori">
                            ...
                            @foreach ($get_kategori_iklan as $data)
                            @if ($status_form === "create_form")
                            ...
                            @elseif ($status_form === "edit_form")
                                <option value="{{ $data->title }}" 
                                    {{ $data->title == $item->kategori ? 'selected' : '' }}>
                                    {{ ucfirst(str_replace('_', ' ', $data->title)) }}
                                </option>
                            @endif
                            @endforeach
                        </select>
                        <label for="author">Kategori Iklan</label>
                    </div>
                   ...
                   <div class="d-none">
                    ...
                    <div class="row">
                        ...
                        <div class="form-floating form-floating-outline mb-3 mt-3">
                          <input type="text" class="form-control" id="link_iklan" name="link_iklan" placeholder=" " 
                          aria-describedby="floatingInputLink" value="@if ($status_form === "edit_form"){{ $item->link }}@endif">
                          <label for="Link Iklan">Link Iklan</label>
                          <div id="floatingInputLink" class="form-text">
                          </div>
                          @error('link_iklan') <span class="text-danger">{{ $message }}</span> @enderror
                        </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-12 col-md-7">
                        ...
                        <div class="form-floating form-floating-outline mb-3 mt-3" hidden>
                          ...
                          name="edit_image_src" 
                          value="@if($status_form == 'edit_form'){{$gambar_iklan_utama}}@endif"
                          ...
                          <input type="text" class="form-control" id="image_iklan_filename" 
                          name="image_iklan_filename" 
                          value="@if($status_form == 'edit_form'){{$gambar_iklan_file}}@endif"
                          placeholder=" " aria-describedby="floatingFilename">
                          <label for="Image Filename">Image Src</label>
                          <div id="floatingFilename" class="form-text">
                          </div>
                      </div>
                      </div>
                    </div>
        ...
        function tampil_gambar_iklan_edit()
            {
                ...
                var filename_image_iklan  = $('#image_iklan_filename').val();
                if(filename_image_iklan == ''){
                    var full_path_img = edit_src_img;
                }else{
                    var full_path_img = url_img + 'assets/iklan/' + filename_image_iklan;
                }
                ...
                if(formname=='edit'){
                    ...
                    $('#myform').append('<input type="hidden" name="addimage_iklan" class="form-control" value="'+filename_image_iklan+'" />');
